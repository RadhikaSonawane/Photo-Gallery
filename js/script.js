/************************* To receive all photos from Flickr API ********************************/
 ...
 { 
	 if(getPhotos)
	{
		...
		script.src="https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=b9711611ae9a76c65daee96667caf69a&tags="+textInput+"&format=json&jsoncallback=DisplayPhotos";
		document.getElementsByTagName("head")[0].appendChild(script);   
	}   
	else
	{
		alert("No Image found :( may be api has some problem try later")
	}
 } 
